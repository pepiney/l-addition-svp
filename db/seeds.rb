...
restaurant2 = Restaurant.create!(name: "Chez Francis et Cabrel", address: "92-106 Corniche Président John Fitzgerald Kennedy, 13007 Marseille", user: user3, photo: "https://lh3.googleusercontent.com/gSOCe6-7mRShz414U1EIoTu7s1EFnBBwnwqx0FuHbsyGQL9Bi0IToLJkm3R7FQI8p4UPbD58kMdf9_gyOzXsxw=w850-h510-c", description: "Groupe live tout les jeudi soir")
...
Restaurant.create!(name: "Sur la route des papilles enchantées", address: "16 Rue Fort du Sanctuaire, 13006 Marseille", user: user3, photo: "http://www.l-epuisette.fr/wp-content/uploads/2014/08/top-accueil-1.jpg", description: "Terrasse de 200m2")
