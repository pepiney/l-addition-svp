...
Customer.create!(user: user2, last_name: "dupond", first_name: "jean", avatar: "https://vignette.wikia.nocookie.net/loisetclark/images/7/74/Clark_30.PNG/revision/latest?cb=20180703121739&path-prefix=fr")
...
restaurant2 = Restaurant.create!(name: "Chez Francis et Cabrel", address: "92-106 Corniche Président John Fitzgerald Kennedy, 13007 Marseille", user: user1, photo: "https://lh3.googleusercontent.com/gSOCe6-7mRShz414U1EIoTu7s1EFnBBwnwqx0FuHbsyGQL9Bi0IToLJkm3R7FQI8p4UPbD58kMdf9_gyOzXsxw=w850-h510-c", description: "Groupe live tout les jeudi soir")
...
Restaurant.create!(name: "L'hirondelle coquine", address: "5 Avenue Camille Pelletan, 13003 Marseille", user: user1, photo: "https://www.frequence-sud.fr/admin/transfert/data/72152.jpg", description: "Spécialité aÏoli")
Restaurant.create!(name: "Une vie, un avis", address: "280 Chemin de la Madrague-Ville, 13015 Marseille", user: user1, photo: "https://d18dnr0ekxokj7.cloudfront.net/actualites-marseille/2018/07/restaurant-la-grotte-callelongue-500x335.jpg", description: "Restaurant de fruits de mer")
Restaurant.create!(name: "Sur la route des papilles enchantées", address: "16 Rue Fort du Sanctuaire, 13006 Marseille", user: user1, photo: "http://www.l-epuisette.fr/wp-content/uploads/2014/08/top-accueil-1.jpg", description: "Terrasse de 200m2")
